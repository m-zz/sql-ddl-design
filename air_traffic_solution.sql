...
CREATE TABLE tickets (
  ...
  from_airport_code TEXT NOT NULL REFERENCES airport_codes,
  to_airport_code TEXT NOT NULL REFERENCES airport_codes,

  UNIQUE (seat, departure, airline_id, from_airport_code, to_airport_code),
